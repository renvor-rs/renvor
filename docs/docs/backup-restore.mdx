...
# No "Edit this page" link WHILE THIS PAGE IS UNMERGED — see database-portability.mdx for the full
# reason. Docusaurus builds that link from `editUrl`, which points at `tree/main/docs/`; for a page
# not yet on `main` it 404s and fails verification step 10.
# REMOVE THIS LINE once this page is on `main`.
