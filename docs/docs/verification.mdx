...
| 11 | Documentation cross-references | `python3 scripts/check-doc-references.py` |
| 12 | Working-tree cleanliness | no untracked or modified files remain |

Step 8 runs **both** scanners. The history scan cannot see uncommitted files; the
