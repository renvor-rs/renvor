...
> **Acceptance gate.** Same as ADR-0001: three of W-002's four compensating controls are
> met; "all required CI and security checks passing" cannot be until T057–T059 exist and
> run. See [Acceptance gate](#acceptance-gate).
