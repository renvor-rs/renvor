...
granted by pointing at a predecessor. That is a real constraint, and it is the only one here.
...
- This review **MUST NOT** be described as independent, in the record, in the evidence pack, in
  ...
  recorded exception.
- ADR-0007 may not reach `accepted` until **all six** compensating controls listed for W-004 are
  complete and the review record is dated.
