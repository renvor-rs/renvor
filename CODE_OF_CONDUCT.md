...
We as members, contributors, and leaders pledge to make participation in the Renvor
...
requests, discussions, and any project communication channel — and also applies when an
...
**A note on scale.** Renvor currently has a single maintainer, who is therefore also the
sole enforcer of this document. That is a real limitation: there is no separate body to
appeal to, and no independent review of an enforcement decision. It is stated here rather
than left for someone to discover at the worst possible moment. If a report concerns the
maintainer, you are under no obligation to route it through them — raising it publicly, or
with a neutral third party in the wider Rust community, is legitimate.

## Enforcement guidelines

Community leaders will follow these guidelines in determining the consequences for any
...
Conduct, for a specified period. Violating these terms may lead to a temporary or
permanent ban.
...
the community for a specified period. Violating these terms may lead to a permanent ban.
